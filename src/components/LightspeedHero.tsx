...
export function LightspeedHero() {
  ...
  // Styles: stem widens a bit less, spacing fixed
  useEffect(() => {
    const style = document.createElement("style");
    style.textContent = `
      .campanile {
        --width: 0.80em;         /* glyph advance width */
        --baseline: -0.11em;     /* baseline nudge */
        --gap: 0.035em;          /* constant spacing before "I" */
      ...
      /* HOVER: foot disappears; stem thickens a bit (center anchored); tower appears */
